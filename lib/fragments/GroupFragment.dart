                  ...
                  return RefreshIndicator(
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        ...
                        children: [
                          Container(
                            decoration: BoxDecoration(borderRadius: BorderRadius.circular(8), color: white, boxShadow: defaultBoxShadow()),
                            child: TextField(
                              ...
                              decoration: InputDecoration(
                                ...
                                prefixIcon: Transform.scale(
                                  scale: 0.4,
                                  child: SvgPicture.asset(AppAssets.magnifying_glass, color: gray, height: 16),
                                ),
                          ...
                          Gap.k8.height,
                          groups.where((gr) => gr.groupMembers!.any((mem) => mem.role == 'Owner' && mem.user!.id == UserRepo.user.id)).toList().isNotEmpty
                          ...
                          GroupsList(
                              groups: groups
                                  .where((gr) => !joinedGroups.contains(gr) && !groups.where((gr) => gr.groupMembers!.any((mem) => mem.role == 'Owner' && mem.user!.id == UserRepo.user.id)).contains(gr))
                                  .toList()),
                          Gap.kSection.height,
                        ],
                      ).paddingSymmetric(horizontal: 16),
